...
class Converter:
    def __init__(self):
        ...
        self.help_button = Button(self.hist_help_frame, font="Arial 12 bold", text="Help",
                                  width=5, command=self.help)
    ...
    def help(self):
        get_help = Help(self)
        get_help.help_text.configure(text="Please enter a number in the box and the push one of the "
                                          "buttons to convert the number to either degrees C or degrees "
                                          "F. \n \n The Calculation History area shows up to seven past "
                                          "calculations (most recent at the top). \n\n You can also export"
                                          " your full calculation history to a text file if desired.")
    ...
    def __init__(self, partner, calc_history):
        ...
        if len(calc_history) > 7:
            ...
            for item in calc_history:
                ...
                self.history_text.config(text="Here is your calculation history. You can use the export button to save "
                                              "this data to a text file is desired.")
